...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'apiProductTest';
  ...
  'jhipster.mail.from' = 'apiProductTest@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'apiProductTest API';
  'jhipster.swagger.description' = 'apiProductTest API documentation';
  ...
  'eureka.instance.appname' = 'apiProductTest';
  'eureka.instance.instanceId' = 'apiProductTest:${random.value}';
  ...
  'cloud.config.name' = 'apiProductTest';
