  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="apiProductTestApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Category" id="product-category" name="category" data-cy="category" type="text" />
